...
model.load_weights('best_butterResnet_38_279.hdf5')
print('-'*30)
...
jaccard=jaccard_similarity_score(val_accumulator_label, predicted_labels, normalize=True, sample_weight=None)
